    ...
    fetch('/views/nav/navbar.html')
        ...
        .then(data => {
            ...
            if (notificationsDropdown) {
                ...
                socket.on('notifications', function(notifications) {
                    ...
                    notifications.forEach((notification) => {
                        ...
                        notificationItem.innerHTML = `
                            <div class="notification">
                                <div class="notification-header">
                                    ...
                                    <span>${notification.title || notification.medication_name}</span>
                                </div>
                        ...
                        `;
                        notificationsDropdown.insertBefore(notificationItem, notificationsDropdown.firstChild); // Insert at the top
                    });
                });
                ...
                fetch('/notify')
                    ...
                    .then(data => {
                        ...
                        notifications.forEach((notification, index) => {
                            ...
                            `;
                            notificationsDropdown.appendChild(notificationItem); // Insert at the bottom
                        });
                    })
                    .catch(error => {
            ...
            window.handleMedicationAction = function(action, notificationId, index) {
                console.log(`Handling action: ${action} for notificationId: ${notificationId} at index: ${index}`);
